...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .sf-reset ul a,
            .sf-reset ul a:hover {
                background: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAICAYAAAAx8TU7AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAFdJREFUeNpiYACBjjOhDEiACSggCKTLgXQ5TJARqhIkcReIKxgqTGYxwvV0nDEGkmeAOIwJySiQ4HsgvseIpGo3ELsCtZ9lRDIvDCiwhwHJPEFkJwEEGACq6hdnax8y1AAAAABJRU5ErkJggg==') no-repeat right;
                padding-right: 10px;
            }
            .sf-reset ul, ol {
                padding-left: 20px;
